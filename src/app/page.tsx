...
export default function LandingPage() {
  ...
  return (
    <div ref={mainRef} className='h-screen'>
      <div className='flex justify-center items-center bg-linear-to-b from-[rgb(20,20,20)] to-black h-full'>
        <motion.div
          className='z-0 relative flex flex-col space-y-20 bg-linear-to-br from-[rgba(209,209,209,0.03)] to-[rgba(245,245,245,0.14)] shadow-lg rounded-sm w-[90%] h-[75%] overflow-hidden'
        ...
        >
          ...
          <div className='z-10 relative space-y-2 pl-12'>
            ...
            <motion.p className='max-w-xl text-gray-400' variants={itemVariants}>
              Discover a world of creativity and expression. Join us to share your thoughts, ideas,
          ...
          <div className='-right-25 -bottom-37.5 z-0 absolute w-3xl h-[70%] rotateImgEffectParent'>
            <img
      ...
      <motion.div className='flex flex-col justify-center items-center gap-y-1 bg-black p-10 pt-48 w-full'>
        <motion.h1 variants={gridVariants} {...whileViewProps} custom={0} className='text-6xl'>
        ...
        <div className='relative overflow-hidden'>
          <Marquee pauseOnHover={true} className='py-4 [--duration:50s]'>
            {landingPageBlogPosts.map((post) => (
              <div key={post.id} className='shrink-0 mx-2 w-87.5'>
                <article className='flex flex-col bg-[rgb(20,20,20)] p-6 hover:border-gray-600 rounded-md h-full transition-colors'>
                  ...
                  <p className='grow mb-4 text-gray-300 line-clamp-3'>{post.description}</p>
                </article>
              </div>
            ))}
          </Marquee>

          <div className='-right-1 z-40 absolute inset-y-0 bg-linear-to-l from-[#070707] w-1/3 pointer-events-none'></div>
          <div className='-left-1 z-40 absolute inset-y-0 bg-linear-to-r from-[#070707] w-1/3 pointer-events-none'></div>
        </div>
      </section>

      <div className='flex flex-col justify-center items-center gap-y-10 bg-linear-to-b from-black to-[rgb(22,22,22)] pt-52 overflow-hidden'>
        <motion.div variants={slideVariants} {...whileViewProps} className='pb-16'>
      ...
      <div className='flex flex-col justify-center items-center bg-linear-to-b from-[rgb(22,22,22)] to-[rgb(97,97,102)] pt-56 pb-56'>
      ...
      <div className='flex justify-center items-center bg-[rgb(97,97,102)] w-full h-24'>
        <p className='text-gray-400 text-sm'>© 2025 Blography. All rights reserved.</p>
      </div>
    </div>
  )
}
