      ...
      <div className='flex flex-col gap-4'>
        <div className='flex items-center gap-3'>
          ...
          <div className='flex flex-col gap-1'>
            ...
            <p className='text-neutral-400 text-sm'>Write it down. Remember it forever.</p>
          </div>
        </div>

        <div className='flex items-center gap-3'>
          <NewDoc />
          <div className='flex flex-col gap-2 bg-[#262626] p-4 border border-[#404040] rounded-md w-40 md:w-70 cursor-pointer'>
        ...
        <div className='flex flex-col'>
          {Array.isArray(documents) &&
            ...
            documents.slice(0, 5)?.map((document: any, i: number) => (
              <div
                key={document._id}
                className={`flex justify-between items-end p-4 border border-[#404040] ${
                  i == 4 ? 'border-b! rounded-b-md' : ''
                } w-full cursor-pointer ${i === 0 ? 'rounded-t-md' : ''} ${
